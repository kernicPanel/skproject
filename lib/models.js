...
AppUsers.methods.getApiKey = function() {
...
AppUsers.methods.startIssue = function( issue, callback ){
  console.log("AppUsers startIssue : ", issue.id);
  if (this.currentTask.id) {
    this.stopIssue( callback );
  }

  this.currentTask.issueId = issue.id.toString();
  this.currentTask.issueName = issue.subject;
  this.currentTask.issueStatus = "en cours";
  this.currentTask.issueTime = "0";
  this.currentTask.issueUrl = issue.url;
  // this.currentTask.login = username;
  this.currentTask.id = issue.id.toString();
...
AppUsers.methods.pauseIssue = function( callback ){
  if (this.currentTask.paused) {
    ...
    this.currentTask.issueStatus = "en pause";
  }
  this.save();
  callback( null, this.currentTask );
};
...
AppUsers.methods.stopIssue = function( callback ){
  ...
  if (this.currentTask.id) {
      ...
      // this.currentTask = {};
      this.currentTask.issueId = null;
      this.currentTask.issueName = null;
      this.currentTask.issueStatus = null;
      this.currentTask.issueTime = null;
      this.currentTask.issueUrl = null;
