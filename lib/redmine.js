...
var redmine ={},
    ...
    ioEvent = require('./ioManager').ioEvent;
...
redmine.init = function() {
    ...
    ioEvent.emit('push', 'redmine::connect');
    ioEvent.on('getUsersIssues', function() {
        console.log("ioevent recieve getUsersIssues: ");
        redmine.getUsersIssues( function(err, data) {
            //socket.emit('getUsersIssues::response', data);
            ioEvent.emit('push', data);
        });
    });
/*
