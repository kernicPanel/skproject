...
eventsManager.on('irc::command', function(from, command, args, callback){
    console.log("eventsManager irc::command : ", from, command, args);
    eventsManager.emit('redmine::ircCommand', from, command, args, function(err, response){
        console.log("eventsManager irc::command response : ", err, response);
