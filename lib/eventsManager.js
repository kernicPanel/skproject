...
eventsManager.connect = function(socket) {
  ...
  server.addUser( username, function(){} );
    ...
    socket.on('getUserIssues', function(id, callback){
        ...
        // socket.emit('log', id);
        eventsManager.emit('getUserIssues', id, function(err, data){
    ...
    socket.on('redmine::startIssue', function(id, callback){
    ...
    socket.on('redmine::pauseIssue', function( callback ){
        eventsManager.emit('redmine::pauseIssue', username, function(err, data){
            callback(err, data);
        });
    });

    socket.on('redmine::stopIssue', function( callback ){
