...
eventsManager.connect = function(socket) {
  ...
  server.addUser( username, function(){} );
    ...
    socket.on('startIssue', function(id, callback){
      ...
      console.log("startIssue : ", username, id);
    ...
    socket.on('pauseIssue', function( callback ){
      console.log("pauseIssue : ", username);
    ...
    socket.on('stopIssue', function(  callback ){
        console.log("stopIssue : ", username);
    ...
    socket.on('addTime', function(issue, callback){
        //var username = server.users[socket.handshake.session.username];
        console.log("addTime : ", username, issue);
        // eventsManager.emit('log', issue);
        eventsManager.emit('timer::addtime', username, issue, function(err, data){
            callback(err, data);
        });
    });
